...
function EditProfilePictureModal({ userId, setSelectedUser, fetchUser }) {
   ...
   const handleSubmit = async(e) =>{
      ...
      try{
         ...
         const filePath = `images/profile/coverPhotos/${fileName}`
            ...
            <motion.div className='modal file-modal' variants={modal}>
               <form onSubmit={handleSubmit}>
                  ...
                  <div className="auth-form-group mb-1">
                     <label htmlFor="image" className='file-label'>Profile Photo</label>
                     <input
                  ...
                  {
                     loading && <ProgressBarUpload progress={progress}/>
                  }
               </form>
            </motion.div>
         </motion.div>   
