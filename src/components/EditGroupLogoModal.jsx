...
function EditGroupLogoModal({ groupId, setSelectedGroupForLogo, fetchGroup }) {
   ...
   const handleSubmit = async(e) =>{
      ...
      try{
         ...
         const filePath = `images/groups/logos/${fileName}`
            ...
            <motion.div className='modal file-modal' variants={modal}>
               <form onSubmit={handleSubmit}>
                  ...
                  <div className="auth-form-group mb-1">
                     <label htmlFor="image" className='file-label'>Group Logo</label>
                     <input
...
export default EditGroupLogoModal